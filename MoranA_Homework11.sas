...
ID of 1, but the ID is missing.  It may seem trival here because we could
...
data dogs;
input Breed $ name $ cost;

if Breed ne '' then newbreed=Breed;
retain newbreed;
